...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2019 a las 17:58:16
...
CREATE TABLE `historical_constructions` (
  ...
  `constructions_id` int(11) NOT NULL,
...
INSERT INTO `localities` (`id`, `name`, `cities_id`) VALUES
(1, 'Puente aranda', 495);
...
CREATE TABLE `participation` (
  ...
  `participationcol` varchar(45) DEFAULT '',
...
ALTER TABLE `historical_constructions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_historical_constructions_constructions1_idx` (`constructions_id`),
  ADD KEY `fk_historical_constructions_files1_idx` (`files_id`);
...
ALTER TABLE `localities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_localities_cities1_idx` (`cities_id`);
...
ALTER TABLE `participation`
  ...
  ADD KEY `fk_participation_constructions1_idx` (`constructions_id`);
...
ALTER TABLE `pqrs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pqrs_files1_idx` (`files_id`),
...
--
-- AUTO_INCREMENT de la tabla `participation`
--
ALTER TABLE `participation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `historical_constructions`
  ADD CONSTRAINT `fk_historical_constructions_constructions1` FOREIGN KEY (`constructions_id`) REFERENCES `constructions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_historical_constructions_files1` FOREIGN KEY (`files_id`) REFERENCES `files` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `localities`
--
ALTER TABLE `localities`
  ADD CONSTRAINT `fk_localities_cities1` FOREIGN KEY (`cities_id`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `participation`
--
ALTER TABLE `participation`
  ADD CONSTRAINT `fk_participation_constructions1` FOREIGN KEY (`constructions_id`) REFERENCES `constructions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `pqrs`
  ...
  ADD CONSTRAINT `fk_pqrs_files1` FOREIGN KEY (`files_id`) REFERENCES `files` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
