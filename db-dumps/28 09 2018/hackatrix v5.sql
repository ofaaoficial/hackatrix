...
-- Tiempo de generación: 28-09-2019 a las 20:06:16
...
CREATE TABLE IF NOT EXISTS `cities` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cities_departments1_idx` (`department_id`),
...
CREATE TABLE IF NOT EXISTS `constructions` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_constructions_entitys1_idx` (`entity_id`),
  KEY `fk_constructions_cities1_idx` (`city_id`),
  KEY `fk_constructions_construction_type1_idx` (`construction_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `constructions`
--

INSERT INTO `constructions` (`id`, `name`, `start_date`, `estimated_date_completion`, `objetive`, `general_observations`, `entity_id`, `city_id`, `construction_type_id`, `money_invested`, `latitude`, `longitude`) VALUES
(2, 'pruebahjhbvcx1', '2019-09-28 00:00:00', '2020-09-28 23:59:59', 'bla bla', 'bla bla', 1, 1, 1, '1000', 0, 0);
...
--
-- Volcado de datos para la tabla `construction_type`
--
...
CREATE TABLE IF NOT EXISTS `entities` (
  ...
  `country_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_entitys_countries1_idx` (`country_id`)
...
(5, 'Administracion del sistema', '301301301', 'oscarfamado@email.com', 48),
(6, 'Entidad 1', '301301301', 'entidad@email.com', 48),
(7, 'pruebahjhbvcx1111111111111', '111111', 'res@gmail.com', 1);
...
INSERT INTO `files` (`id`, `name`, `type`, `ubication`) VALUES
(1, 'tumblr_p64899fvjC1vox13io1_640.jpg', 'jpg', 'storage/app/files_pqrs/'),
(2, 'tumblr_p64899fvjC1vox13io1_640.jpg', 'jpg', 'storage/app/files_pqrs/'),
(3, 'tumblr_p64899fvjC1vox13io1_640.jpg', 'jpg', 'storage/app/files_pqrs/'),
(4, 'tumblr_p64899fvjC1vox13io1_640.jpg', 'jpg', 'storage/app/files_pqrs/'),
(5, 'tumblr_p64899fvjC1vox13io1_640.jpg', 'jpg', 'storage/app/files_pqrs/');
...
DROP TABLE IF EXISTS `historical_constructions`;
CREATE TABLE IF NOT EXISTS `historical_constructions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_historical_constructions_constructions1_idx` (`construction_id`),
  KEY `fk_historical_constructions_files1_idx` (`file_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `historical_constructions`
--

INSERT INTO `historical_constructions` (`id`, `description`, `construction_id`, `file_id`, `date`) VALUES
(2, 'Hola', 2, NULL, '2019-09-28 00:00:00'),
(3, 'dsadasd', 2, NULL, '2019-09-28 00:00:00'),
(4, 'dsadasd', 2, 2, '2019-09-28 00:00:00');
...
CREATE TABLE IF NOT EXISTS `localities` (
  ...
  `city_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_localities_cities1_idx` (`city_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `participations` (
  ...
  `construction_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_participation_users1_idx` (`user_id`),
  KEY `fk_participation_constructions1_idx` (`construction_id`)
...
CREATE TABLE IF NOT EXISTS `pqrs` (
  ...
  `entity_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pqrs_files1_idx` (`file_id`),
  KEY `fk_pqrs_pqrs_type_request1_idx` (`pqrs_type_request_id`),
  KEY `fk_pqrs_entitys1_idx` (`entity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
INSERT INTO `pqrs` (`id`, `name`, `description`, `email`, `date`, `file_id`, `pqrs_type_request_id`, `entity_id`) VALUES
(2, 'foto1', 'preuab 1', 'gg@gmail.com', '2019-09-26 00:00:00', 1, 1, 3);
...
DROP TABLE IF EXISTS `pqrs_replies`;
CREATE TABLE IF NOT EXISTS `pqrs_replies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_pqrs_reply_files1_idx` (`files_id`),
  KEY `fk_pqrs_replies_pqrs1_idx` (`pqr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `pqrs_replies`
--

INSERT INTO `pqrs_replies` (`id`, `answer`, `date`, `files_id`, `pqr_id`) VALUES
(2, 'Hola', '2019-09-28 00:00:00', 5, 2);
...
DROP TABLE IF EXISTS `pqrs_types_request`;
CREATE TABLE IF NOT EXISTS `pqrs_types_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
--
-- Volcado de datos para la tabla `pqrs_types_request`
--

INSERT INTO `pqrs_types_request` (`id`, `name`) VALUES
(1, 'xzc');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `fk_users_entitys1_idx` (`entity_id`),
...
(3, 'Oscar', 'Amado', 'oscarfamado@gmail.com', 1, 1, '1022445546', 'T9SJVTzAdZ96ZeVTQ56X59kyyYf41oWMdZbeBdX0eCG7yqBOGpicCys8k7wZKf3WE5BqndbFoCxloK3T8cY3FVyMxQbqTrC5mc0n1909', '$2y$10$5EEJpiMewOnjZToV0Z.Ob.aVGa/kPy0ozMt7e2NmwkDWsshWqp.4u');
